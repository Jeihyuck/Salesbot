...
class activate_key_model_price(models.Model):
    ...
    actv_phone_plan_seq = models.IntegerField(verbose_name= "개통폰 요금제 정책 순번", null=False, blank=False)
...
class activate_model_base(models.Model):
    mdl_code       = models.CharField(max_length=100, verbose_name= "모델 코드", null=False, blank=False)
    key_mdl_code   = models.CharField(max_length=100, verbose_name= "키 모델 코드", null=True, blank=True)
...
class activate_phone_plan(models.Model):
    ...
    date_of_publication                = models.CharField(max_length=100,verbose_name= "공시일", null=True, blank=True)
...
class ai_aio_mst(models.Model):
    mst_goods_id         = models.CharField(max_length=15, verbose_name= "마스터 상품 아이디", null=False, blank=False)
    ssb_goods_id         = models.CharField(max_length=15, verbose_name= "구독 상품 아이디", null=False, blank=False)
...
class ai_smart_svc(models.Model):
    svc_goods_id         = models.CharField(max_length=15, verbose_name= "서비스 상품 아이디", null=False, blank=False)    
    ssb_goods_id         = models.CharField(max_length=15, verbose_name= "구독 상품 아이디", null=False, blank=False)
...
class aisc_goods_base(models.Model): 
    ssb_goods_id = models.CharField(verbose_name='구독 상품 아이디', max_length=15, null=False, blank=False)
    mdl_code     = models.CharField(verbose_name='모델 코드', max_length=20, null=True, blank=True)
    seg_cd1      = models.CharField(verbose_name='세그먼트 코드1', max_length=5, null=True, blank=True)
    seg_cd2      = models.CharField(verbose_name='세그먼트 코드2', max_length=5, null=True, blank=True)
    seg_cd3      = models.CharField(verbose_name='세그먼트 코드3', max_length=5, null=True, blank=True)
...
class aisc_goods_price(models.Model): 
    ssb_prc_no     = models.IntegerField(verbose_name='구독 가격 번호', null=False, blank=False)    
    ssb_goods_id   = models.CharField(verbose_name='구독 상품 아이디', max_length=15, null=False, blank=False)    
...
class aisc_goods_std_info(models.Model): 
    std_seq       = models.IntegerField(verbose_name= "기준 순번", null=False, blank=False)    
...
class aisc_service_goods_base(models.Model): 
    ssb_svc_seq    = models.IntegerField(verbose_name='구독 서비스 순번', null=False, blank=False)    
    svc_goods_id   = models.CharField(verbose_name='서비스 상품 아이디', max_length=15, null=False, blank=False)    
...
class bc_base(models.Model):    
    bc_id                   = models.CharField(max_length=15, verbose_name="BC 아이디", null=False, blank=False)
    st_id                   = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)
...
class bc_conts_info(models.Model):    
    bc_conts_no     = models.IntegerField(verbose_name= "BC 컨텐츠 번호", null=False, blank=False)
...
class card_istm_info(models.Model):
    istm_seq                = models.IntegerField(verbose_name= "할부 순번", null=False, blank=False)
    sid                     = models.CharField(max_length=20, verbose_name="대표 SID", null=True, blank=True)
    st_id                   = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)
    ...
    no_itrst_strt_dt        = models.CharField(max_length=16, verbose_name="무이자 시작 일자", null=True, blank=True)
    no_itrst_end_dt         = models.CharField(max_length=16, verbose_name="무이자 종료 일자", null=True, blank=True)
...
class careplus_goods_category(models.Model):
    goods_id         = models.CharField(max_length=15, verbose_name= "상품 아이디 (부모상품)", null=False, blank=False)
    cpls_ctgry_cd    = models.CharField(max_length=10, verbose_name= "케어플러스 카테고리 코드", null=False, blank=False)
    use_prd_tp_cd    = models.CharField(max_length=10, verbose_name= "사용 기간 유형 코드", null=False, blank=False)
...
class cis_base(models.Model): 
    model_code              = models.CharField(verbose_name='model_code', max_length=50, null=False, blank=False)
    plant                   = models.CharField(verbose_name='plant', max_length=100, null=False, blank=False)
...
class cis_tree(models.Model):                
    model_code          = models.CharField(verbose_name='model_code', max_length=1000, null=False, blank=False)
    plant               = models.CharField(verbose_name='plant', max_length=10, null=False, blank=False)
    division            = models.CharField(verbose_name='division', max_length=20, null=True, blank=True)
...
class code_detail(models.Model): 
    grp_cd       = models.CharField(verbose_name='그룹 코드', max_length=30, null=False, blank=False)
    dtl_cd       = models.CharField(verbose_name='상세 코드', max_length=20, null=False, blank=False)
...
class conts_cstrt_info(models.Model):  
    conts_cstrt_no = models.IntegerField(verbose_name= "컨텐츠 구성 번호", null=False, blank=False)
    ...
    class Meta:
        unique_together = ('conts_cstrt_no', 'site_cd')        
        indexes = [models.Index(fields=['conts_no', 'cpt_no'], name="r_data_conts_cstrt_idx")]


class conts_info(models.Model):  
    conts_no      = models.IntegerField(verbose_name= "컨텐츠 번호", null=False, blank=False)
...
class coupon_base(models.Model):   
    cp_no                   = models.IntegerField(verbose_name= "쿠폰 번호", null=False, blank=False)
...
class coupon_target(models.Model):        
    cp_no          = models.IntegerField(verbose_name= "쿠폰 번호", null=False, blank=False)
    apl_seq        = models.DecimalField(verbose_name= "적용 순번", null=False, blank=False, max_digits=5, decimal_places=0)
    disp_clsf_no   = models.IntegerField(verbose_name= "전시 분류 번호", null=True, blank=True)
...
class cpt(models.Model):  
    cpt_no               = models.IntegerField(verbose_name= "컴포넌트 번호", null=False, blank=False)
...
class display_category(models.Model):  
    disp_clsf_no            = models.IntegerField(null=False, blank=False, verbose_name="전시 분류 번호")
...
class display_clsf_filter(models.Model):
    ...
    filter_no            = models.IntegerField(verbose_name= "필터 번호", null=False, blank=False)
...
class display_clsf_filter_item(models.Model):
    disp_clsf_no         = models.IntegerField(verbose_name= "전시 분류 번호", null=False, blank=False)
    filter_no            = models.IntegerField(verbose_name= "필터 번호", null=False, blank=False)
    filter_item_no       = models.IntegerField(verbose_name= "필터 아이템 번호", null=False, blank=False)
    ...
    class Meta:
        indexes = [models.Index(fields=['disp_clsf_no', 'filter_no', 'filter_item_no', 'use_yn', 'site_cd'], name="r_data_disp_item_idx")]
...
class display_ctg_caution(models.Model):        
    disp_clsf_no   = models.IntegerField(verbose_name= "전시 분류 번호", null=False, blank=False)
    seq            = models.DecimalField(verbose_name= "순번", null=False, blank=False, max_digits=5, decimal_places=0)
...
class display_goods(models.Model):
    disp_clsf_no            = models.IntegerField(verbose_name= "전시 분류 번호", null=False, blank=False)
    goods_id                = models.CharField(max_length=15, verbose_name= "상품 번호", null=False, blank=False)
    disp_prior_rank         = models.IntegerField(verbose_name= "전시 우선 순위", null=True, blank=True)
    dlgt_disp_yn            = models.CharField(max_length=1, verbose_name= "대표 전시 여부", null=True, blank=True)    
...
class filter_item_prdt_map(models.Model):
    ...
    filter_item_no   = models.IntegerField(verbose_name= "필터 아이템 번호", null=False, blank=False)
    filter_map_tp_cd = models.CharField(max_length=10, verbose_name= "필터 맵 유형 코드", null=True, blank=True)
    tg_no            = models.IntegerField(verbose_name= "대상 번호", null=False, blank=False)
    sys_reg_dtm      = models.DateTimeField(null=True, blank=True, verbose_name="시스템 등록 일시")        
    base_ymd         = models.DateField(verbose_name='기준일', null=True, blank=True)
    ld_dt            = models.DateTimeField(verbose_name='적재일시', null=True, blank=True)
    site_cd          = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
    ...
    class Meta:
        indexes = [models.Index(fields=['filter_map_tp_cd', 'disp_clsf_no', 'filter_no', 'filter_item_no', 'site_cd'], name="r_data_filter_item_idx")]
...
class goods_add_column_info(models.Model):
    ...
    goods_col_gb_cd         = models.CharField(max_length=10, verbose_name="상품 컬럼 구분 코드 (code_detail.dtl_cd = goods_col_gb)", null=False, blank=False)
...
class goods_add_on_base(models.Model):
    add_on_no       = models.IntegerField(verbose_name= "ADD-ON 번호", null=False, blank=False)
...
class goods_add_on_category(models.Model):    
    add_on_ctg_no    = models.IntegerField(verbose_name= "ADD-ON 분류 번호", null=False, blank=False)
    add_on_no        = models.IntegerField(verbose_name= "ADD-ON 번호", null=False, blank=False)
...
class goods_base(models.Model):
    ...
    class Meta:
        indexes = [models.Index(fields=['goods_id', 'goods_stat_cd', 'mid1'], name="r_data_gb_fields_idx"),]


class goods_comment(models.Model):
    goods_estm_no      = models.IntegerField(verbose_name= "상품 평가 번호", null=False, blank=False)
    st_id  			   = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)
    goods_id  		   = models.CharField(max_length=15, verbose_name="상품 아이디", null=False, blank=False)
...
class goods_comment_grouped_stat(models.Model):
    model_code       = models.CharField(max_length=100, verbose_name="모델 코드", null=True, blank=True)
    avg_review_score = models.DecimalField(verbose_name= "평균 리뷰 점수", max_digits=5, decimal_places=2, null=True, blank=True)
    review_count     = models.IntegerField(verbose_name= "리뷰 수", null=True, blank=True)
    updated_on       = models.DateTimeField(verbose_name='Update', auto_now=True)
    site_cd          = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")


class goods_comment_grouped_summary(models.Model):
    goods_id      = models.CharField(max_length=15, verbose_name= "상품 아이디", null=True, blank=True)
    st_id         = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)
    goods_estm_no = models.IntegerField(verbose_name= "상품평 번호", null=False, blank=False)
    sys_reg_dtm   = models.DateTimeField(null=True, blank=True, verbose_name="시스템 등록 일시")
...
class goods_comment_keyword(models.Model):  
    goods_estm_no     = models.IntegerField(verbose_name= "상품평 번호", null=False, blank=False)
    goods_cmnt_kwd_cd = models.CharField(max_length=3, verbose_name= "상품평 키워드 코드", null=False, blank=False)    
    sys_reg_dtm       = models.DateTimeField(null=True, blank=True, verbose_name="시스템 등록 일시")   
    base_ymd          = models.DateField(verbose_name='기준일', null=True, blank=True)
    ld_dt             = models.DateTimeField(verbose_name='적재일시', null=True, blank=True)
    site_cd           = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
...
class goods_cstrt_info(models.Model): 
    goods_id               = models.CharField(verbose_name='상품 아이디', max_length=15, null=False, blank=False)    
    goods_cstrt_gb_cd      = models.CharField(verbose_name='상품 구성 구분 코드', max_length=10, null=False, blank=False)    
    cstrt_goods_id         = models.CharField(verbose_name='구성 상품 아이디', max_length=15, null=False, blank=False)    
...
class goods_desc(models.Model):
    goods_id                = models.CharField(max_length=15, verbose_name= "상품 아이디", null=False, blank=False)
    svc_gb_cd               = models.CharField(max_length=10, verbose_name= "서비스 구분 코드", null=True, blank=True)
    content                 = models.TextField(verbose_name= "내용", null=True, blank=True)
    sys_reg_dtm             = models.DateTimeField(verbose_name= "시스템 등록 일시", null=True, blank=True)
    sys_upd_dtm             = models.DateTimeField(verbose_name= "시스템 수정 일시", null=True, blank=True)
    base_ymd                = models.DateField(verbose_name='기준일', null=True, blank=True)
...
class goods_grp_key_info(models.Model):    
    grp_key_no              = models.IntegerField(verbose_name= "그룹 키 번호", null=False, blank=False)
    st_id                   = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)    
    ...
    class Meta:
        indexes = [models.Index(fields=['grp_key_no', 'grp_key_tp_cd', 'site_cd'], name="r_data_gki_fields_idx")]
...
class goods_grp_key_map(models.Model):
    ...
    class Meta:
        indexes = [models.Index(fields=['grp_key_no', 'site_cd'], name="r_data_gkm_fields_idx")]

class goods_notify(models.Model):
    ntf_item_id = models.CharField(max_length=15, verbose_name= "고시 항목 아이디", null=False, blank=False)
    goods_id    = models.CharField(max_length=15, verbose_name= "상품 아이디", null=False, blank=False)
...
class goods_opt_item_map(models.Model):
    goods_id         = models.CharField(max_length=15, verbose_name= "상품 아이디", null=False, blank=False)
    prdt_opt_item_no = models.IntegerField(verbose_name= "상품 옵션 아이템 번호", null=False, blank=False)
...
class goods_price(models.Model):
    goods_prc_no            = models.IntegerField(verbose_name= "상품 가격 번호", null=False, blank=False)
    goods_id                = models.CharField(max_length = 15, verbose_name= "상품 아이디", null=True, blank=True)
    sale_strt_dtm           = models.DateTimeField(verbose_name= "판매 시작 일시", null=True, blank=True)
    sale_end_dtm            = models.DateTimeField(verbose_name= "판매 종료 일시", null=True, blank=True)
    ...
    class Meta:
        indexes = [models.Index(fields=['goods_id', 'sale_strt_dtm', 'sale_end_dtm'], name="r_data_gp_fields_idx"),]


class gscm_prodmaster(models.Model):
    item          = models.CharField(max_length=100, verbose_name= "Item", null=False, blank=False)
    gbm           = models.CharField(max_length=100, verbose_name= "GBM", null=True, blank=True)
    section       = models.CharField(max_length=100, verbose_name= "Section", null=True, blank=True)
    type          = models.CharField(max_length=100, verbose_name= "Type", null=True, blank=True)
    toolname      = models.CharField(max_length=100, verbose_name= "Tool Name", null=True, blank=True)
    classcategory = models.CharField(max_length=100, verbose_name= "Category", null=True, blank=True)
    buyer         = models.CharField(max_length=100, verbose_name= "Buyer", null=True, blank=True)
    basicname     = models.CharField(max_length=100, verbose_name= "Basic Name", null=True, blank=True)
    project       = models.CharField(max_length=100, verbose_name= "Project", null=True, blank=True)
    modelgroup    = models.CharField(max_length=100, verbose_name= "Model Group", null=True, blank=True)
    scmtype       = models.CharField(max_length=100, verbose_name= "SCM Type", null=True, blank=True)
    productgroup  = models.CharField(max_length=100, verbose_name= "Product Group", null=True, blank=True)
    product       = models.CharField(max_length=100, verbose_name= "Product", null=True, blank=True)
    attb01        = models.CharField(max_length=100, verbose_name= "Attribute 01", null=True, blank=True)
    attb02        = models.CharField(max_length=100, verbose_name= "Attribute 02", null=True, blank=True)
    attb03        = models.CharField(max_length=100, verbose_name= "Attribute 03", null=True, blank=True)
    attb04        = models.CharField(max_length=100, verbose_name= "Attribute 04", null=True, blank=True)
    attb05        = models.CharField(max_length=100, verbose_name= "Attribute 05", null=True, blank=True)
    attb06        = models.CharField(max_length=100, verbose_name= "Attribute 06", null=True, blank=True)
    attb07        = models.CharField(max_length=100, verbose_name= "Attribute 07", null=True, blank=True)
    attb08        = models.CharField(max_length=100, verbose_name= "Attribute 08", null=True, blank=True)
    attb09        = models.CharField(max_length=100, verbose_name= "Attribute 09", null=True, blank=True)
    attb10        = models.CharField(max_length=100, verbose_name= "Attribute 10", null=True, blank=True)
    attb11        = models.CharField(max_length=100, verbose_name= "Attribute 11", null=True, blank=True)
    attb12        = models.CharField(max_length=100, verbose_name= "Attribute 12", null=True, blank=True)
    attb13        = models.CharField(max_length=100, verbose_name= "Attribute 13", null=True, blank=True)
    attb14        = models.CharField(max_length=100, verbose_name= "Attribute 14", null=True, blank=True)
    attb15        = models.CharField(max_length=100, verbose_name= "Attribute 15", null=True, blank=True)
    attb16        = models.CharField(max_length=100, verbose_name= "Attribute 16", null=True, blank=True)
    attb17        = models.CharField(max_length=100, verbose_name= "Attribute 17", null=True, blank=True)
    attb18        = models.CharField(max_length=100, verbose_name= "Attribute 18", null=True, blank=True)
    productcode   = models.CharField(max_length=100, verbose_name= "Product Code", null=True, blank=True)
    modelname     = models.CharField(max_length=100, verbose_name= "Model Name", null=True, blank=True)
    dpattb01      = models.CharField(max_length=100, verbose_name= "Display Attribute 01", null=True, blank=True)
    dpattb02      = models.CharField(max_length=100, verbose_name= "Display Attribute 02", null=True, blank=True)
    eancode       = models.CharField(max_length=100, verbose_name= "EAN Code", null=True, blank=True)
    upccode       = models.CharField(max_length=100, verbose_name= "UPC Code", null=True, blank=True)
    ...
    sdw_base_ymd  = models.CharField(max_length=100, verbose_name='SDW Base Date', null=True, blank=True)
    sdw_ld_dt     = models.DateTimeField(verbose_name='SDW Load Date', null=True, blank=True)


class notify_item(models.Model):
    ntf_item_id  = models.CharField(max_length=15, verbose_name= "고시 항목 아이디", null=False, blank=False)
    ntf_id       = models.CharField(max_length=15, verbose_name= "고시 아이디", null=False, blank=False)
...
class pf_goods_list(models.Model):            
    ...
    class Meta:
        indexes = [models.Index(fields=['up_disp_clsf_no', 'en_grp_key_no', 'goods_id', 'site_cd'], name="r_data_pfg_fields_idx"),]


class pg_benefit_base(models.Model):
    pg_bnft_no                      = models.IntegerField(verbose_name="결제 혜택 번호", null=False, blank=False)
    ...
    class Meta:
        indexes = [models.Index(fields=['disp_strt_dtm', 'disp_end_dtm', 'bnft_stat_cd', 'pg_bnft_no', 'mid'], name="r_data_pgbbase_fields_idx"),]


class pg_benefit_detail(models.Model):       
    pg_bnft_no     = models.IntegerField(verbose_name= "결제 혜택 번호", null=False, blank=False)
    pg_bnft_seq    = models.IntegerField(verbose_name= "결제 혜택 순번", null=False, blank=False)
...
class pg_mid(models.Model):
    mid                             = models.CharField(max_length=20, verbose_name="MID", null=False, blank=False)
...
class prd_mst_hist(models.Model):    
    ...
    set_tp_cd               = models.CharField(verbose_name='Set Type Code', max_length=2, null=True, blank=True)
    created_on              = models.DateTimeField(verbose_name='Create', auto_now_add=True)
    updated_on              = models.DateTimeField(verbose_name='Update', auto_now=True)
    site_cd                 = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
    pd_url                  = models.TextField(verbose_name= "상품 URL", null=True, blank=True)
    dlgt_img_url            = models.TextField(verbose_name= "대표 이미지 URL", null=True, blank=True)
...
class product_card(models.Model):
    ...
    class Meta:        
        unique_together = ('goods_id', 'site_cd')
...
class product_category(models.Model):
    ...
    mdl_code                = models.CharField(verbose_name='Mdl Code', max_length=1000, null=True, blank=True)
    goods_id                = models.CharField(verbose_name='Goods Id', max_length=1000, null=False, blank=False)
    goods_nm                = models.CharField(verbose_name='Goods Nm', max_length=1000, null=True, blank=True)
    ...
    class Meta:
        unique_together = ('goods_id', 'site_cd')
        indexes = [models.Index(fields=['goods_id', 'mdl_code'], name="r_data_pc_fields_idx"),
                   models.Index(fields=['mdl_code', 'site_cd', 'goods_stat_cd', 'show_yn'], name="r_data_pc_fields2_idx"),]  


class product_detail_spec_info(models.Model):
    mdl_code                        = models.CharField(max_length=100, verbose_name="모델 코드", null=False, blank=False)
    seq                             = models.DecimalField(verbose_name="순번", max_digits=10, decimal_places=0, null=False, blank=False)
...
class product_filter(models.Model):
    ...
    product_model           = models.CharField(verbose_name='Product Name', max_length=1000, null=True, blank=True)
    mdl_code                = models.CharField(verbose_name='Mdl Code', max_length=1000, null=True, blank=True)
    goods_id                = models.CharField(verbose_name='상품 번호', max_length=1000, null=False, blank=False)
    ...
    class Meta:
        unique_together = ('goods_id', 'disp_clsf_nm', 'filter_nm', 'filter_item_nm', 'site_cd')
        indexes = [models.Index(fields=['product_category_lv1', 'product_category_lv2', 'product_category_lv3', 'goods_id', 'mdl_code'], name="r_data_pfilter_idx"),
                   models.Index(fields=['filter_nm', 'filter_item_nm', 'site_cd'], name="r_data_pfilter_idx2"),]


class product_filter_hst(models.Model):
    business_unit           = models.CharField(verbose_name='Business Unit', max_length=1000, null=True, blank=True)
    product_category_lv1    = models.CharField(verbose_name='Product Category Lv1', max_length=1000, null=True, blank=True)
    product_category_lv2    = models.CharField(verbose_name='Product Category Lv2', max_length=1000, null=True, blank=True)
    product_category_lv3    = models.CharField(verbose_name='Product Category Lv3', max_length=1000, null=True, blank=True)    
...
class product_images(models.Model):
    ...
    img_url        = models.CharField(max_length=1000, verbose_name= "이미지 URL", null=False, blank=False)
    ...
    class Meta:
        unique_together = ('goods_id', 'img_url', 'site_cd')


class product_images_hist(models.Model):
    goods_id       = models.CharField(max_length=15, verbose_name= "상품 아이디", null=False, blank=False)
    mdl_code       = models.CharField(max_length=300, verbose_name="모델 코드", null=True, blank=True)
    type           = models.CharField(max_length=10, verbose_name="타입", null=True, blank=True)
    dlgt_yn        = models.CharField(max_length=1, verbose_name="대표 여부", null=True, blank=True)
...
class product_recommend(models.Model):                
    ...
    updated_on           = models.DateTimeField(verbose_name='Update', auto_now=True)
    site_cd              = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
    sorting_type         = models.CharField(max_length=10, verbose_name="정렬 유형", null=True, blank=True)

    class Meta:
        unique_together = ('goods_id', 'site_cd', 'sorting_type')
...
class product_set_mst(models.Model):
    disp_lv1                = models.CharField(verbose_name='Display Lv1', max_length=100, null=True, blank=True)
    disp_lv2                = models.CharField(verbose_name='Display Lv2', max_length=100, null=True, blank=True)
    disp_lv3                = models.CharField(verbose_name='Display Lv3', max_length=100, null=True, blank=True)
    product_category_lv1    = models.CharField(verbose_name='Product Category Lv1', max_length=100, null=True, blank=True)
    product_category_lv2    = models.CharField(verbose_name='Product Category Lv2', max_length=100, null=True, blank=True)
    product_category_lv3    = models.CharField(verbose_name='Product Category Lv3', max_length=100, null=True, blank=True)
    goods_id                = models.CharField(verbose_name='Goods Id', max_length=15, null=False, blank=False)
    mdl_code                = models.CharField(verbose_name='Mdl Code', max_length=100, null=False, blank=False)
    goods_nm                = models.CharField(verbose_name='Goods Nm', max_length=1000, null=True, blank=True)
    set_tp_cd               = models.CharField(verbose_name='세트 유형 코드', max_length=10, null=True, blank=True)
    cstrt_category_lv1      = models.CharField(verbose_name='구성 카테고리 Lv1', max_length=100, null=True, blank=True)
    cstrt_category_lv2      = models.CharField(verbose_name='구성 카테고리 Lv2', max_length=100, null=True, blank=True)
    cstrt_category_lv3      = models.CharField(verbose_name='구성 카테고리 Lv3', max_length=100, null=True, blank=True)
    cstrt_mdl_code          = models.CharField(verbose_name='구성 상품 모델 코드', max_length=100, null=False, blank=False)    
    cstrt_goods_nm          = models.CharField(verbose_name='구성 상품 명', max_length=1000, null=True, blank=True)
    site_cd                 = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")

    class Meta:
        unique_together = ('goods_id', 'mdl_code', 'cstrt_mdl_code', 'site_cd')    
...
class promotion_bundle_group(models.Model):
    prmt_no       = models.IntegerField(verbose_name= "프로모션 번호", null=False, blank=False)
    grp_seq       = models.DecimalField(verbose_name= "그룹 순번", max_digits=5, decimal_places=0, null=False, blank=False)
...
class promotion_bundle_map(models.Model):
    prmt_no       = models.IntegerField(verbose_name= "프로모션 번호", null=False, blank=False)
    main_goods_id = models.CharField(max_length=15, verbose_name= "메인 상품 아이디", null=False, blank=False)
    main_mdl_code = models.CharField(max_length=100, verbose_name= "메인 모델 코드", null=True, blank=True)
    main_mid1     = models.CharField(max_length=100, verbose_name= "메인 MID1", null=True, blank=True)
    apl_goods_id  = models.CharField(max_length=15, verbose_name= "적용 상품 아이디", null=False, blank=False)
    apl_mdl_code  = models.CharField(max_length=100, verbose_name= "적용 모델 코드", null=True, blank=True)
    apl_goods_nm  = models.CharField(max_length=300, verbose_name= "적용 상품 명", null=True, blank=True)
    apl_mid1      = models.CharField(max_length=100, verbose_name= "적용 MID1", null=True, blank=True)
    prmt_apl_cd   = models.CharField(max_length=10, verbose_name= "프로모션 적용 코드", null=True, blank=True)
    apl_sale_prc1 = models.DecimalField(verbose_name= "적용 판매가1", max_digits=10, decimal_places=0, null=True, blank=True)
    apl_sale_prc3 = models.DecimalField(verbose_name= "적용 판매가3", max_digits=10, decimal_places=0, null=True, blank=True)    
    apl_val       = models.DecimalField(verbose_name= "적용 값",  max_digits=10, decimal_places=2, null=True, blank=True)
    cstrt_yn      = models.CharField(max_length=1, verbose_name= "구성 여부", null=True, blank=True)
    created_on    = models.DateTimeField(verbose_name='Create', auto_now_add=True)    
    site_cd       = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
...
class promotion_bundle_target(models.Model):
    prmt_no     = models.IntegerField(verbose_name= "프로모션 번호", null=False, blank=False)
    grp_seq     = models.DecimalField(verbose_name= "그룹 순번",  max_digits=5, decimal_places=0, null=False, blank=False)
    apl_seq     = models.DecimalField(verbose_name= "적용 순번",  max_digits=10, decimal_places=0, null=False, blank=False)
    prmt_apl_cd = models.CharField(max_length=10, verbose_name= "프로모션 적용 코드", null=True, blank=True)
    apl_val     = models.DecimalField(verbose_name= "적용 값",  max_digits=10, decimal_places=2, null=True, blank=True)
    sys_reg_dtm = models.DateTimeField(null=True, blank=True, verbose_name="시스템 등록 일시")    
    sys_upd_dtm = models.DateTimeField(null=True, blank=True, verbose_name="시스템 수정 일시")
...
class rltn_goods_manage(models.Model):    
    seq                             = models.TextField(verbose_name="시퀀스 번호입니다.", null=False, blank=False)    
...
class st_goods_sale_summary(models.Model):
    ...
    tot_sale_amt     = models.DecimalField(verbose_name= "총 판매 금액", max_digits=15, decimal_places=0, null=True, blank=True)
...
class st_prdt_opt(models.Model):
    prdt_opt_no    = models.IntegerField(verbose_name= "상품 옵션 번호", null=False, blank=False)
    st_id          = models.IntegerField(verbose_name= "사이트 아이디", null=True, blank=True)
...
class svc_center_mst(models.Model):
    gname              = models.CharField(max_length=100, verbose_name="센터 명", null=True, blank=True)
    lat                = models.DecimalField(max_digits=10, decimal_places=6, verbose_name="위도", null=True, blank=True)
    lng                = models.DecimalField(max_digits=10, decimal_places=6, verbose_name="경도", null=True, blank=True)
    rcode1             = models.CharField(max_length=100, verbose_name="시도 명", null=True, blank=True)
    rcode2             = models.CharField(max_length=100, verbose_name="시군구 명", null=True, blank=True)
    doroname           = models.CharField(max_length=100, verbose_name="도로명", null=True, blank=True)
    address_doro       = models.CharField(max_length=200, verbose_name="도로명 주소", null=True, blank=True)
    weekday_start      = models.CharField(max_length=10, verbose_name="주중 시작일시", null=True, blank=True)
    weekday_end        = models.CharField(max_length=10, verbose_name="주중 종료일시", null=True, blank=True)
    saturday_start     = models.CharField(max_length=10, verbose_name="토요일 시작일시", null=True, blank=True)
    saturday_end       = models.CharField(max_length=10, verbose_name="토요일 종료일시", null=True, blank=True)
    saturday_closed    = models.CharField(max_length=1, verbose_name="토요일 영업 여부", null=True, blank=True)
    holiday_start      = models.CharField(max_length=10, verbose_name="휴일 시작일시", null=True, blank=True)
    holiday_end        = models.CharField(max_length=10, verbose_name="휴일 종료일시", null=True, blank=True)
    holiday_closed     = models.CharField(max_length=1, verbose_name="휴일 영업 여부", null=True, blank=True)
    base_ymd           = models.DateField(verbose_name='기준일', null=True, blank=True)
    ld_dt              = models.DateTimeField(verbose_name='적재일시', null=True, blank=True)
    site_cd            = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")


class table_check(models.Model):
    from_table_nm = models.CharField(max_length=100, verbose_name="원본 테이블 이름", null=False, blank=False)
    to_table_nm   = models.CharField(max_length=100, verbose_name="대상 테이블 이름", null=False, blank=False)
    from_row_cnt  = models.IntegerField(verbose_name="원본 테이블 레코드 수", null=True, blank=True)
    to_row_cnt   = models.IntegerField(verbose_name="대상 테이블 레코드 수", null=True, blank=True)
    result        = models.CharField(max_length=10, verbose_name="비교 결과", null=True, blank=True)
    created_on    = models.DateTimeField(verbose_name='Create', auto_now_add=True)
...
class uk_order_cards_info(models.Model):
    ...
    created_on              = models.DateTimeField(verbose_name='Create', auto_now_add=True)
    updated_on              = models.DateTimeField(verbose_name='Update', auto_now=True)
    country_code            = models.CharField(verbose_name='국가코드', null=False, blank=False, default='GB')
    site_cd                 = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
...
class uk_product_comment(models.Model):
    review_id        = models.IntegerField(verbose_name= "리뷰 아이디", null=False, blank=False)
    model_code       = models.CharField(max_length=100, verbose_name= "모델 코드", null=True, blank=True)
...
class uk_product_comment_statistics(models.Model):
    model_code       = models.CharField(max_length=100, verbose_name= "모델 코드", null=False, blank=False)
    model_name       = models.CharField(max_length=1000, verbose_name= "모델 명", null=True, blank=True)
    avg_score        = models.DecimalField(verbose_name= "평균 점수", max_digits=5, decimal_places=2, null=True, blank=True)
    review_num       = models.IntegerField(verbose_name= "리뷰 수", null=True, blank=True)
...
class uk_product_cstrt_info(models.Model):
    model_code       = models.CharField(max_length=300, verbose_name= "모델 코드", null=False, blank=False)
    cstrt_model_code = models.CharField(max_length=300, verbose_name= "구성 모델 코드", null=False, blank=False)
...
class uk_product_family_list(models.Model):
    model_code   = models.CharField(verbose_name='모델코드', max_length=255, null=False, blank=False)
    family_id    = models.CharField(verbose_name='패밀리 ID', max_length=255, null=False, blank=False)
    family_name  = models.CharField(verbose_name='패밀리 이름', max_length=255, null=False, blank=False)
    display_name = models.CharField(verbose_name='디스플레이 이름', max_length=255, null=False, blank=False)
    categories   = models.JSONField(verbose_name='카테고리', null=True, blank=True, default=dict)
    key_model_yn = models.CharField(verbose_name='주요 모델 여부', max_length=1, null=False, blank=False)
    updated_on   = models.DateTimeField(verbose_name='업데이트 일시', auto_now=True)
    created_on   = models.DateTimeField(verbose_name='생성 일시', auto_now_add=True)
    country_code = models.CharField(verbose_name='국가 코드', max_length=2, null=True, blank=True)
    site_cd      = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
...
class uk_product_filter(models.Model):
    ...
    filter_nm               = models.CharField(verbose_name='필터명', max_length=255, null=False, blank=False)
    filter_item_nm          = models.CharField(verbose_name='필터값', max_length=255, null=False, blank=False)
    launch_date             = models.DateField(verbose_name='출시일', null=True, blank=True)
    created_on              = models.DateTimeField(verbose_name='Create', auto_now_add=True)
    updated_on              = models.DateTimeField(verbose_name='Update', auto_now=True)
    country_code            = models.CharField(verbose_name='Country Code', max_length=10, null=False, blank=False, default='GB')
    site_cd                 = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
    
    class Meta:        
        indexes = [models.Index(fields=['category_lv1', 'category_lv2', 'category_lv3', 'model_code'], name="r_data_uk_pf_idx"),]


class uk_product_filter_hist(models.Model):
    model_code              = models.CharField(verbose_name='모델코드', max_length=255, null=False, blank=False)
    display_name            = models.CharField(verbose_name='발매일', max_length=255, null=True, blank=True)
    category_lv1            = models.CharField(verbose_name='Category Lv1', max_length=255, null=True, blank=True)
    category_lv2            = models.CharField(verbose_name='Category Lv2', max_length=255, null=True, blank=True)
    ...
    class Meta:        
        indexes = [models.Index(fields=['category_lv1', 'category_lv2', 'category_lv3', 'model_code'], name="r_data_uk_pf_hst_idx"),]


class uk_product_order(models.Model): 
    country_code         = models.CharField(max_length=10, verbose_name="국가 코드", null=False, blank=False, default='GB')
    type_name            = models.CharField(verbose_name='type_name', max_length=26, null=False, blank=False)    
    ...
    representative_model = models.CharField(verbose_name='representative_model', max_length=20, null=False, blank=False)
...
class uk_product_rltn(models.Model):
    model_code       = models.CharField(max_length=300, verbose_name= "모델 코드", null=False, blank=False)
    rltn_model_code  = models.CharField(max_length=300, verbose_name= "연관 모델 코드", null=False, blank=False)
...
class uk_product_set_mst(models.Model):
    category_lv1       = models.CharField(max_length=300, verbose_name= "카테고리 레벨1", null=True, blank=True)
    category_lv2       = models.CharField(max_length=300, verbose_name= "카테고리 레벨2", null=True, blank=True)
    category_lv3       = models.CharField(max_length=300, verbose_name= "카테고리 레벨3", null=True, blank=True)
    model_code         = models.CharField(max_length=300, verbose_name= "모델 코드", null=False, blank=False)
    display_name       = models.CharField(max_length=300, verbose_name= "디스플레이 명", null=True, blank=True)
    cstrt_category_lv1 = models.CharField(max_length=300, verbose_name= "구성 카테고리 레벨1", null=True, blank=True)
    cstrt_category_lv2 = models.CharField(max_length=300, verbose_name= "구성 카테고리 레벨2", null=True, blank=True)
    cstrt_category_lv3 = models.CharField(max_length=300, verbose_name= "구성 카테고리 레벨3", null=True, blank=True)
    cstrt_model_code   = models.CharField(max_length=300, verbose_name= "구성 모델 코드", null=False, blank=False)
    cstrt_display_name = models.CharField(max_length=300, verbose_name= "구성 디스플레이 명", null=True, blank=True)
    country_code       = models.CharField(max_length=10, null=False, blank=False, verbose_name="국가 코드", default='GB')
    site_cd            = models.CharField(max_length=10, null=False, blank=False, verbose_name="닷컴 코드", default="B2C")
...
class uk_product_smc_info(models.Model):
    ...
    preselected                            = models.CharField(max_length=10, verbose_name= "사전 선택 여부", null=True, blank=True)
    ...
    theft                                  = models.CharField(max_length=10, verbose_name= "도난 여부", null=True, blank=True)
    ...
    updated_on                             = models.DateTimeField(verbose_name='Update', auto_now=True)
    country_code                           = models.CharField(max_length=10, verbose_name="국가 코드", null=False, blank=False, default='GB')
    site_cd                                = models.CharField(max_length=5, verbose_name="닷컴 코드", null=False, blank=False, default="B2C")
...
class uk_product_spec_basics_hist(models.Model):
    model_code              = models.CharField(verbose_name='모델코드', null=False, blank=False)
    display                 = models.CharField(verbose_name='전시여부', null=True, blank=True)
    country_code            = models.CharField(verbose_name='국가코드', null=False, blank=False, default="GB")
    is_b2c                  = models.CharField(verbose_name='B2C여부', null=True, blank=True)
    ...
    class Meta:
        unique_together = ('model_code', 'country_code', 'site_cd')     
        indexes = [models.Index(fields=['category_lv1', 'category_lv2', 'category_lv3', 'model_code', 'display_name'], name="r_data_ukbasics_hist_idx")]
...
class uk_product_spec_spec(models.Model):
    ...
    class Meta:
        unique_together = ('model_code', 'types', 'spec_type', 'spec_name', 'spec_detail','spec_value', 'country_code', 'site_cd')
        indexes = [models.Index(fields=['model_code', 'spec_type', 'spec_value'], name="r_data_ukpsspec_fields_idx")]


class uk_product_spec_spec_hist(models.Model):
    model_code              = models.CharField(verbose_name='모델코드', null=False, blank=False)
    types                   = models.CharField(verbose_name='SPEC 구분', null=True, blank=True)
    spec_type               = models.CharField(verbose_name='SPEC TYPE(LV1)', null=True, blank=True)
    spec_name               = models.CharField(verbose_name='SPEC NAME(LV2)', null=True, blank=True)
    ...
    class Meta:
        unique_together = ('model_code', 'types', 'spec_type', 'spec_name', 'spec_detail','spec_value', 'country_code', 'site_cd')
        indexes = [models.Index(fields=['model_code', 'spec_type', 'spec_value'], name="r_data_ukspec_hist_idx")]
...
class uk_product_visual_contents(models.Model):
    model_code        = models.CharField(max_length=300, verbose_name= "모델 코드", null=False, blank=False)
    img_type          = models.CharField(max_length=50, verbose_name= "이미지 타입", null=False, blank=False)
    sorting_no        = models.IntegerField(verbose_name= "정렬 번호", null=False, blank=False)
...
class uk_product_visual_contents_hist(models.Model):
    model_code        = models.CharField(max_length=300, verbose_name= "모델 코드", null=False, blank=False)
    img_type          = models.CharField(max_length=50, verbose_name= "이미지 타입", null=False, blank=False)
    sorting_no        = models.IntegerField(verbose_name= "정렬 번호", null=False, blank=False)
    type              = models.CharField(max_length=100, verbose_name= "타입", null=True, blank=True)
...
class uk_store_plaza(models.Model):
    searchableid              = models.CharField(verbose_name='검색 가능한 ID', null=False, blank=False)
    ...
    country_code              = models.CharField(verbose_name='국가 코드', null=False, blank=False, default='GB')
...
class graph_db(models.Model):
    goods_id         = models.CharField(max_length=15, verbose_name= "상품 아이디", null=False, blank=False)
    country_code     = models.CharField(verbose_name='국가코드', max_length=2, null=False, blank=False)
    grouped_products = ArrayField(models.CharField(max_length=300), verbose_name= "그룹 상품", null=True, blank=True)
    goods_nm         = models.CharField(max_length=300, verbose_name= "상품 명", null=True, blank=True)
    disp_lv1         = models.CharField(max_length=100, verbose_name= "1차 전시 카테고리", null=True, blank=True)
    disp_lv2         = models.CharField(max_length=100, verbose_name= "2차 전시 카테고리", null=True, blank=True)
    disp_lv3         = models.CharField(max_length=100, verbose_name= "3차 전시 카테고리", null=True, blank=True)
    pd_url           = models.CharField(max_length=1000, verbose_name= "상품 URL", null=True, blank=True)
    update_tag       = models.CharField(max_length=100, verbose_name= "업데이트 태그", null=True, blank=True)
    processed        = models.BooleanField(verbose_name='Graph DB 처리 여부', default=False)


class graph_db_data(models.Model):
    id               = models.AutoField(primary_key=True)
    active           = models.BooleanField(verbose_name='Active', default=False)
    country_code     = models.CharField(verbose_name='국가코드', max_length=2, null=False, blank=False)
    src_id           = models.IntegerField(verbose_name= "Source ID")
    edge_id          = models.IntegerField(verbose_name= "Edge ID")
    dst_id           = models.IntegerField(verbose_name= "Destinamtion ID")
    src_name         = models.CharField(verbose_name= "Source Name", null=True, blank=True)
    dst_name         = models.CharField(verbose_name= "Destinamtion Name", null=True, blank=True)
    content_key      = models.CharField(verbose_name= "Content Key", null=True, blank=True)
    contents         = models.CharField(verbose_name= "내용", null=True, blank=True)
    processed        = models.BooleanField(verbose_name='Graph DB Text 적재 여부', default=False)

    class Meta:
        indexes = [models.Index(fields=['country_code', 'src_id', 'edge_id', 'dst_id', 'src_name', 'dst_name', 'content_key'], name="r_graph_db_data_idx")]
