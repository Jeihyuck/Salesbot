<template>
  <draggable
    ...
    @input="updateValue"
  >
    <alpha-draggable-tree-view-node
      v-for="item in value"
      :key="item.id"
      :group="group"
      :value="item"
...
import alphaDraggableTreeViewNode from '@/components/alpha/alphaDraggableTreeviewNode.vue'

export default {
  name: 'alphaDraggableTreeView',
  components: {
    draggable,
    alphaDraggableTreeViewNode
  },
  props: {
    value: {
      type: Array,
